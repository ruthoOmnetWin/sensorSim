...
Mit Abbildung \ref{fig:switchingModes5000} ist ein Beispiel gegeben, bei dem alle 3 Events in Verwendung waren. Dabei ist natürlich von der Sensorsteuerung nicht viel zu sehen. Alle 5000 Sekunden wurde hierbei der Modus gewechselt, beginnend bei dem normalen Modus, danach einem Energie sparenden Modus und zuletzt einem Modus mit sehr hohem Energieverbrauch. Danach wieder beginnend von vorn. Dabei wurde alle 1000 Sekunden der Ladezustand abgefragt. Diese Operationen wurden auf 3 verschiedenen Sensorknoten parallel durchgeführt. Man kann sehr gut sehen, dass der blaue Verlauf besonders schnell nach unten geht. Das liegt daran, dass dort ein Knoten mit 4 Sensoren genutzt wurde. Der Grüne dagegen konnte deutlich länger am Leben bleiben, weil dieser Knoten keinen Sensor besaß. Der Energieverbrauch aller Bauteile war bei allen 3 Sensorknoten analog.
...
\todo{beispiele implementieren und beschreiben}