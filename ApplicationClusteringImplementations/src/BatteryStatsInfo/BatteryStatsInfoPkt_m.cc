//
// Generated file, do not edit! Created by opp_msgc 4.5 from BatteryStatsInfo/BatteryStatsInfoPkt.msg.
//
...
#include <iostream>
#include <sstream>
#include "BatteryStatsInfoPkt_m.h"
...
double ApplPkt::getResidualRelative() const
{
    return residualRelative_var;
}

void ApplPkt::setResidualRelative(double residualRelative)
{
