 ...
 **************************************************************************/
#ifndef WAKEUPBASE_MAC_LAYER_H
#define WAKEUPBASE_MAC_LAYER_H
 ...
 */
class WakeupBaseMacLayer : public BaseLayer
{
public:
...
private:
     ...
     */
    WakeupBaseMacLayer(const WakeupBaseMacLayer&);
    /** @brief Assignment operator is not allowed.
     */
    WakeupBaseMacLayer& operator=(const WakeupBaseMacLayer&);
...
public:
    ...
    WakeupBaseMacLayer()
      ...
      , phyHeaderLength(0)
    {}
    WakeupBaseMacLayer(unsigned stacksize)
      : BaseLayer(stacksize)
      , phy(NULL)
      , headerLength(0)
      , myMacAddr(LAddress::L2NULL)
