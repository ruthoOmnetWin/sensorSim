...
Define_Module(WakeupBaseMacLayer);
 ...
 *
 **/
void WakeupBaseMacLayer::initialize(int stage)
{
...
void WakeupBaseMacLayer::registerInterface()
{
#ifdef MIXIM_INET
 ...
 **/
cPacket* WakeupBaseMacLayer::decapsMsg(macpkt_ptr_t msg)
{
 ...
 * header fields.
 **/
WakeupBaseMacLayer::macpkt_ptr_t WakeupBaseMacLayer::encapsMsg(cPacket *netwPkt)
{
 ...
 **/
void WakeupBaseMacLayer::handleUpperMsg(cMessage *mac)
{
...
void WakeupBaseMacLayer::handleLowerMsg(cMessage *msg)
{
...
void WakeupBaseMacLayer::handleLowerControl(cMessage* msg)
{
    switch (msg->getKind())
    {
...
Signal* WakeupBaseMacLayer::createSignal(simtime_t_cref start, simtime_t_cref length, double power, double bitrate)
{
...
Mapping* WakeupBaseMacLayer::createConstantMapping(simtime_t_cref start, simtime_t_cref end, Argument::mapped_type_cref value)
{
...
Mapping* WakeupBaseMacLayer::createRectangleMapping(simtime_t_cref start, simtime_t_cref end, Argument::mapped_type_cref value)
{
    //create mapping over time
...
ConstMapping* WakeupBaseMacLayer::createSingleFrequencyMapping(simtime_t_cref             start,
                                                         simtime_t_cref             end,
...
BaseConnectionManager* WakeupBaseMacLayer::getConnectionManager() const
{
    return ConnectionManagerAccess::getConnectionManager(getNic());
}

const LAddress::L2Type& WakeupBaseMacLayer::getUpperDestinationFromControlInfo(const cObject * const pCtrlInfo) const
{
 ...
 */
cObject* WakeupBaseMacLayer::setUpControlInfo(cMessage * const pMsg, const LAddress::L2Type& pSrcAddr)
{
 ...
 */
cObject* WakeupBaseMacLayer::setDownControlInfo(cMessage * const pMsg, Signal * const pSignal)
{
